...
class parent():
    ...
    def chemicalEngineer(chemical_name):
        chemical_industry_company_list = ["Honeywell", "Reliance Industries", "First Student", "Nones"]
        random_chemical_industry_company = random.randint(0,3) 
        label_selected_chemical['text']  = chemical_name +" has been alloted to "+ chemical_industry_company_list[random_chemical_industry_company]
